...
public class PrincipalController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        Empresa emp = new Empresa("22660046000170", "Lojão do Queima", cid);      
        ...
        VendedorEmpresa vendEmp = new VendedorEmpresa(ven, emp, 8, 45098.80, 2345.9);
        ...
        vendEmp = new VendedorEmpresa(ven, emp, 8, 54045.80, 4545.9);
        vendedorEmpresaRepository.insert(vendEmp);
